...
public class GameBoard {
    ...
    public GameBoard() {
        ...
        this.regArrayTop = new Region[] {point_1_R, point_2_R, point_3_R, point_4_R, point_5_R, point_6_R,
                point_7_R, point_8_R, point_9_R, point_10_R, point_11_R, point_12_R};
    ...
    public void initialize() {
        ...
        window.widthProperty().addListener((obs, oldVal, newVal) -> {
            ...
            for (int i=0; i<12; i++) {
                ...
                //regArrayTop[i].setPrefWidth((boardRect.getWidth())/24);
                /*polArrayTop[i].setLayoutX(boardRect.getLayoutX()+(i*(boardRect.getWidth())));
                polArrayTop[i].getPoints().setAll(0d, 0d,
                        (i+1)*(boardRect.getWidth()), 0d,
                        (i*(boardRect.getWidth())+boardRect.getWidth()/2), boardRect.getY()+regArrayTop[i].getPrefHeight() );*/
